...
assert.match(source, /editorCues\.push\(\{ id: nextCueId\+\+, start, end, text, x, y, size, voice \}\);/, "new cue stores the speaker");
assert.match(source, /Object\.assign\(cue, \{ start, end, text, x, y, size, voice \}\);/, "cue update stores the speaker");
